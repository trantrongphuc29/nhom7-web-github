...
const API_BASE_URL = process.env.REACT_APP_API_URL || 'http://nhom7-web-backend.gt.tc/api';
const BACKEND_BASE_URL = process.env.REACT_APP_BACKEND_URL || 'http://nhom7-web-backend.gt.tc';
